...
export default function StudyRecruitPage({
  ...
  return (
    <>
      <div className="mx-auto flex max-w-screen-xl items-start justify-between gap-[40px] px-5 pt-[60px] xl:px-0">
        {/* 왼쪽 영역 */}
        <div className="flex flex-auto flex-col gap-[16px]">
          ...
          <div className="flex items-center gap-[4px]">
            {data?.data.getRecruitmentPositionResponseList.map((item) => (
              ...
              >
                {
                  positionList.find((position) => position.value === item.title)
                    ?.label
                }{' '}
